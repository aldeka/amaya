...
get_header(); ?>
            ...
            <div class="section row details">
              <div class="col-lg-4 col-sm-12">
                <p>
                    <span class="col-sm-12 col-lg-12"><a href="http://www.orderstart.com/amayabarandgrill" class="btn btn-large">View menu</a></span>
                    ...
                    <span class="col-sm-6 col-lg-12"><a href="http://www.orderstart.com/amayabarandgrill" class="btn btn-large btn-primary">Order takeout</a></span>
                </p>
              </div>
            ...
            <div class="row">
              ...
              <div class="mailing-list col-sm-6 col-lg-8">
