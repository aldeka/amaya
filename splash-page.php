...
get_header(); ?>
            ...
            <div class="section row details">
              <div class="col-lg-4 col-sm-12">
                <p>
                    <span class="col-sm-12 col-lg-12"><button class="btn btn-large">View menu</button> </span>
                    <span class="col-sm-6 col-lg-12"><button class="btn btn-large btn-primary">Make a reservation</button> </span>
                    <span class="col-sm-6 col-lg-12"><button class="btn btn-large btn-primary">Order takeout</button></span>
                </p>
              </div>
